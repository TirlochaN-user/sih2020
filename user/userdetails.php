        ...
        <div class="main-content">
            ...
            <div class="main-content-inner">
                <div style="margin-top:100px">
                    <h2 style="margin:10px">Name
                        <small class="text-muted"><?php echo $_SESSION['name'] ?></small>
                    </h2>
                    <h2 style="margin:10px">Aadhar Number: 
                        <small class="text-muted"><?php echo $_SESSION['ano'] ?></small>
                    </h2>
                    <h2 style="margin:10px">Mobile Number: 
                        <small class="text-muted"><?php echo $_SESSION['mobileno'] ?></small>
                    </h2>
                </div>
            </div>
